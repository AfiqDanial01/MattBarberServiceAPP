...
import 'admin_show_barbershop_details.dart';

class AdminBarbershopPage extends StatefulWidget {
  const AdminBarbershopPage({Key? key}) : super(key: key);

  @override
  State<AdminBarbershopPage> createState() => _AdminBarbershopPageState();
}

class _AdminBarbershopPageState extends State<AdminBarbershopPage> {
  @override
    ...
    return InkWell(
      onTap: () {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => AdminShowBarbershopDetails(data: data),
          ),
        ).then((value) => setState(() {}));
      },
      child: ListTile(
