...
class ScheduleBookingPage extends StatefulWidget {
  ...
  const ScheduleBookingPage({required this.data, Key? key, required Bookings user}) : super(key: key);
...
class _ScheduleBookingPageState extends State<ScheduleBookingPage> {
  int maxBookingsPerDay = 3; // Set the maximum bookings per day to 3
  int maxBookingsPerInterval =
      2; // Maximum bookings allowed per 30-mincdute interval
