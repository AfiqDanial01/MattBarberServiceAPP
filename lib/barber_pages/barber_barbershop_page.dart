...
class BarberBarbershopPage extends StatefulWidget {
  const BarberBarbershopPage({Key? key}) : super(key: key);

  @override
  State<BarberBarbershopPage> createState() => _BarberBarbershopPageState();
}

class _BarberBarbershopPageState extends State<BarberBarbershopPage> {
  @override
